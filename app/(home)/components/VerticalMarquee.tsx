...
const VerticalMarquee = () => {
  return (
    <div className='relative flex h-96 flex-row items-center space-x-12 space-y-[0.5rem] justify-center overflow-hidden z-0 opacity-20 [perspective:300px]'>
      ...
      <div className='pointer-events-none absolute inset-y-0 -top-2 -left-14 w-1/4 bg-gradient-to-r from-gray-100 dark:from-background'></div>
