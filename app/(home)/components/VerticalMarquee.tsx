...
const ReviewCard = ({
  ...
  return (
    <figure
      className={cn(
        'relative h-auto w-28 cursor-pointer overflow-hidden rounded-xl border p-2',
        // light styles
...
const VerticalMarquee = () => {
  return (
    <div className='relative flex h-96 flex-row items-center space-x-24 justify-center overflow-hidden sm:px-20 z-0 opacity-15 [perspective:300px]'>
      ...
      <Marquee reverse pauseOnHover vertical className='[--duration:20s] hidden 2xl:block'
        style={{
          transform:
            'translateX(0px) translateY(0px) translateZ(0px) rotateX(0deg) rotateY(0deg) rotateZ(-9deg) scale(1.5)',
        }}
