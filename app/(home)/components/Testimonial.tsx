...
const Testimonial = () => {
      return (
            <div className="h-full mx-auto w-full max-w-screen-xl 2xl:max-w-screen-2xl px-0 md:px-20 lg:px-12">
                  <div className="bg-background py-6 md:py-10">
                        <h2 className="mb-2 text-left w-full text-xl font-bold md:text-3xl px-2 ">What people are saying</h2>
