...
//       const { data: certificationsData = [], isLoading, error, refetch } = useQuery({
...
//       const upload_certifications = async () => {
...
//                                     <div key={certification._id} className="flex items-start gap-4">
...
//                                     <Input onChange={(e) => { setCertifications({ ...certifications, year: e.target.value }) }} id="cert-year" defaultValue="2022" />
//                               </div>
...
//                         </div>
//                         <DialogFooter>
//                               <Button onClick={upload_certifications} type="submit">Save changes</Button>
//                         </DialogFooter>
//                   </EditModal>
